...
var CapacitorScope = /** @class */ (function (_super) {
    ...
    CapacitorScope.prototype.addBreadcrumb = function (breadcrumb, maxBreadcrumbs) {
        var mergedBreadcrumb = tslib_1.__assign(tslib_1.__assign({}, breadcrumb), { data: breadcrumb.data ? normalize_1.convertToNormalizedObject(breadcrumb.data) : undefined });
        wrapper_1.NATIVE.addBreadcrumb(mergedBreadcrumb);
        return _super.prototype.addBreadcrumb.call(this, mergedBreadcrumb, maxBreadcrumbs);
    };
    /**
     * @inheritDoc
     */
